...
hidden if the `photo-album_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `photo-album_DEVELOPER_MODE` to the configure
...
Runs the executable target `photo-album_exe`.
